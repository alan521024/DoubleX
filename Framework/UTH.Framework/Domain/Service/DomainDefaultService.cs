namespace UTH.Framework
{
    ...
    /// 应用服务基类实现
    /// </summary>
    public class DomainDefaultService<TEntity> : DomainService, IDomainDefaultService<TEntity>, IDomainService
        where TEntity : class, IEntity<Guid>
    {
        protected readonly IRepository<TEntity, Guid> Repository;

        public DomainDefaultService(IRepository<TEntity, Guid> repository)
        {
        ...
        {
            return Repository.Update(predicate: where, columns: columns, setValueExpression: setValueExpression, entity: entity);
        }
        ...
        {
            return await Repository.UpdateAsync(predicate: where, columns: columns, setValueExpression: setValueExpression, entity: entity);
        }
        ...
        {
            return Repository.Max<TResult>(field: field, name: name, predicate: where);
        }
        ...
        {
            return await Repository.MaxAsync<TResult>(field: field, name: name, predicate: where);
        }
        ...
        {
            return Repository.Min<TResult>(field: field, name: name, predicate: where);
        }
        ...
        {
            return await Repository.MinAsync<TResult>(field: field, name: name, predicate: where);
        }
        ...
        {
            return Repository.Count(predicate: where);
        }
        ...
        {
            return await Repository.CountAsync(predicate: where);
        }
        ...
        {
            return Repository.Sum(field: field, name: name, predicate: where);
        }
        ...
        {
            return await Repository.SumAsync(field: field, name: name, predicate: where);
        }
        ...
        {
            return Repository.Avg(field: field, name: name, predicate: where);
        }
        ...
        {
            return await Repository.AvgAsync(field: field, name: name, predicate: where);
        }
