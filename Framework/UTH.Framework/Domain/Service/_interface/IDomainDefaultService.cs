namespace UTH.Framework
{
    ...
    public interface IDomainDefaultService<TEntity, TKey> : IDomainService where TEntity : class, IEntity<TKey>
    {
        #region 添加对象/集合
    ...
    /// 领域服务接口
    /// </summary>
    public interface IDomainDefaultService<TEntity> : IDomainDefaultService<TEntity, Guid>,
        IDomainService where TEntity : class, IEntity
    {
