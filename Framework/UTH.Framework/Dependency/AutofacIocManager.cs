namespace UTH.Framework
{
    ...
    public class AutofacIocManager : IIocManager
    {
        ...
        public T Resolve<T>(IEnumerable<KeyValueModel<string, object>> parameters)
        {
        ...
        public T Resolve<T>(string name, IEnumerable<KeyValueModel<string, object>> parameters = null)
        {
            List<Parameter> paramItems = new List<Parameter>();
            if (!parameters.IsEmpty())
            {
