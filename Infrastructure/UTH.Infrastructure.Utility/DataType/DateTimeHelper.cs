...
namespace UTH.Infrastructure.Utility
{
    ...
    public static class DateTimeHelper
    {
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static DateTime FormatStartTime(this DateTime dateTime, string format = "00:00:00")
        {
            return DateTime.Parse(dateTime.ToString(format));
        }
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static DateTime FormatEndTime(this DateTime dateTime, string format = "yyyy-MM-dd 23:59:59")
        {
            return DateTime.Parse(dateTime.ToString(format));
        }
