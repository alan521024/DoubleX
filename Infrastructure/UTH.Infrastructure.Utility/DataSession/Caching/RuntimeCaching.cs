...
namespace UTH.Infrastructure.Utility
{
    ...
    public class RuntimeCaching : AbsCaching
    {
        ...
        /// 缓存对象
        /// </summary>
        static MemoryCache objectCache = new MemoryCache(new MemoryCacheOptions());
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="expirationDateTime">过期时间(绝对即：指定在XXX时候过期)</param>
        public override void Set<TEntity>(string key, TEntity entity, DateTime expirationDateTime)
        {
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="slidingExpirationTimeSpan">过期时间(相对即：多少时间内未使用过期)</param>
        public override void Set<TEntity>(string key, TEntity entity, TimeSpan slidingExpirationTimeSpan)
        {
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="filePaths">文件依赖</param>
        public override void Set<TEntity>(string key, TEntity entity, List<string> filePaths)
        {
        ...
        /// <param name="filePaths">文件依赖</param>
        private void SetCache<TEntity>(string key, TEntity obj, DateTime? absoluteExpiration = null, TimeSpan? slidingExpiration = null, List<string> filePaths = null)
        {
