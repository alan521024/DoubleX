...
namespace UTH.Infrastructure.Utility
{
    ...
    public abstract class AbsCaching
    {
        ...
        abstract public TEntity Get<TEntity>(string key) where TEntity : class;
        ...
        abstract public void Set<TEntity>(string key, TEntity entity) where TEntity : class;
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="expirationDateTime">过期时间(绝对即：指定在XXX时候过期)</param>
        abstract public void Set<TEntity>(string key, TEntity entity, DateTime expirationDateTime) where TEntity : class;
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="slidingExpirationTimeSpan">过期时间(相对即：多少时间内未使用过期)</param>
        abstract public void Set<TEntity>(string key, TEntity entity, TimeSpan slidingExpirationTimeSpan) where TEntity : class;
        ...
        /// <param name="entity">内容对象</param>
        /// <param name="filePaths">文件依赖</param>
        abstract public void Set<TEntity>(string key, TEntity entity, List<string> filePaths) where TEntity : class;
