...
namespace UTH.Infrastructure.Utility
{
    ...
    public static partial class Win32
    {
        ...
        private static HDiskInfo GetHddInfoNT(byte driveIndex)
        {
            ...
            {
                CloseHandle(hDevice);
                throw new IOException(string.Format(Win32Message.Win32_DeviceIoControlErr, "SMART_GET_VERSION"));
            }
            // 检测IDE控制命令是否支持  
            if (0 == (vers.fCapabilities & 1))
            {
                CloseHandle(hDevice);
                throw new IOException(Win32Message.Win32_DeviceIoControlNotSupport);
            }
                ...
                IntPtr.Zero))
            {
                ...
                throw new IOException(
                        string.Format(Win32Message.Win32_DeviceIoControlErr, "SMART_RCV_DRIVE_DATA"));
            }
            CloseHandle(hDevice);
        ...
        private static HDiskInfo GetHddInfo9X(byte driveIndex)
        {
            ...
            {
                CloseHandle(hDevice);
                throw new IOException(string.Format(Win32Message.Win32_DeviceIoControlErr, "SMART_RCV_DRIVE_DATA"));
            }
            // 关闭文件句柄  
            CloseHandle(hDevice);
            ChangeByteOrder(outParam.bBuffer.sModelNumber);
        ...
        public static HDiskInfo GetHddInformation()
        {
            switch (currentOs)
            {
                ...
                default:
                    throw new PlatformNotSupportedException(string.Format(Win32Message.Win32_CurrentPlatformNotSupport, currentOs.ToString()));
                case (Platform.UnKnown):
                    throw new PlatformNotSupportedException(Win32Message.Win32_CurrentPlatformUnknown);
    ...
    {
        public static string Win32_DeviceIoControlErr = "设备IO控制错误";
        public static string Win32_DeviceIoControlNotSupport = "设备IO不支持";
        public static string Win32_CurrentPlatformNotSupport = "当前系统不支持";
        public static string Win32_CurrentPlatformUnknown = "当前系统未知";
    }
